...
\newcommand{\dropperTagRocAloha}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/dropper_tag_roc_aloha.png}
        \vspace*{-1cm}
...
\newcommand{\dropperTagRocJointEmbedding}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/dropper_tag_roc_jointEmbedding.png}
        \vspace*{-1cm}
...
\newcommand{\dropperTagRocProposedMethod}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/dropper_tag_roc_proposedModel.png}
        \vspace*{-1cm}

\newcommand{\MrrAndMapResultsTable}{
    \begin{table}[H]
        ...
        \begin{tabular}{|P{2,8cm}||P{2,2cm} P{2,2cm} P{2,2cm} P{2,2cm}|}
            \hline
            & ALOHA (M/B only) & ALOHA & Joint Embedding & MTJE Model \\
            \hline
...
\newcommand{\maxApExampleRankTable}{
    \begin{table}[H]
        ...
        \begin{tabular}{|P{1,8cm}||P{1,7cm} P{1,2cm} P{2cm}|P{1,7cm} P{1,2cm} P{2cm}|}
            ...
            \hline
            \hline
            Max AP & \multicolumn{3}{c|}{Joint Embedding} & \multicolumn{3}{c|}{MTJE Model} \\
            & Sha256 & Label & Family & Sha256 & Label & Family \\
            \hline
...
\newcommand{\maxRrExampleRankTable}{
    \begin{table}[H]
        ...
        \begin{tabular}{|P{1,8cm}||P{1,7cm} P{1,2cm} P{2cm}|P{1,7cm} P{1,2cm} P{2cm}|}
            ...
            \hline
            \hline
            Max RR & \multicolumn{3}{c|}{Joint Embedding} & \multicolumn{3}{c|}{MTJE Model} \\
            & Sha256 & Label & Family & Sha256 & Label & Family \\
            \hline
...
\newcommand{\minApExampleRankTable}{
    \begin{table}[H]
        ...
        \begin{tabular}{|P{1,8cm}||P{1,7cm} P{1,2cm} P{2cm}|P{1,7cm} P{1,2cm} P{2cm}|}
            ...
            \hline
            \hline
            Min AP & \multicolumn{3}{c|}{Joint Embedding} & \multicolumn{3}{c|}{MTJE Model} \\
            & Sha256 & Label & Family & Sha256 & Label & Family \\
            \hline
...
\newcommand{\minRrExampleRankTable}{
    \begin{table}[H]
        ...
        \begin{tabular}{|P{1,8cm}||P{1,7cm} P{1,2cm} P{2cm}|P{1,7cm} P{1,2cm} P{2cm}|}
            ...
            \hline
            \hline
            Min RR & \multicolumn{3}{c|}{Joint Embedding} & \multicolumn{3}{c|}{MTJE Model} \\
            & Sha256 & Label & Family & Sha256 & Label & Family \\
            \hline

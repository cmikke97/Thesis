...
\newcommand{\FamilyClassifierJointEmbeddingConfusionMatrix}{
    \begin{figure}[H]
        ...
        \vspace*{-0.2cm}
        \caption[Family Classifier Joint Embedding Confusion Matrix]{Confusion Matrix resulting from the evaluation of the Family Classifier built on top of the \textit{pre-trained} \textbf{Joint Embedding} model.}
...
\newcommand{\FamilyClassifierMtjeConfusionMatrix}{
    \begin{figure}[H]
        ...
        \vspace*{-0.2cm}
        \caption[Family Classifier MTJE Model Confusion Matrix]{Confusion Matrix resulting from the evaluation of the Family Classifier built on top of the \textit{pre-trained} \textbf{MTJE} Model.}
...
\newcommand{\FamilyClassifierOnlyConfusionMatrix}{
    \begin{figure}[H]
        ...
        \vspace*{-0.2cm}
        \caption[Family Classifier Only Joint Embedding Confusion Matrix]{Confusion Matrix resulting from the evaluation of the \textbf{Family Classifier Only} Model (trained entirely from scratch with no transfer learning).}

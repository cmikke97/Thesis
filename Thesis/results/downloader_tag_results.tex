...
\newcommand{\downloaderTagRocAloha}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/downloader_tag_roc_aloha.png}
        \vspace*{-1cm}
...
\newcommand{\downloaderTagRocJointEmbedding}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/downloader_tag_roc_jointEmbedding.png}
        \vspace*{-1cm}
...
\newcommand{\downloaderTagRocProposedMethod}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/downloader_tag_roc_proposedModel.png}
        \vspace*{-1cm}

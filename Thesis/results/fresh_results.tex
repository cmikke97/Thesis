...
\newcommand{\allConfusionMatrixesMaxAcc}{
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{./results/conf_matrix_max_acc_mtje.png}
            \caption[]{{\small \textBF{MTJE} model implementation}}
            \label{fig:mtjeConfMatrixMaxAcc}
        \end{subfigure}
...
\newcommand{\allConfusionMatrixesMinAcc}{
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{./results/conf_matrix_min_acc_mtje.png}
            \caption[]{{\small \textBF{MTJE} model implementation}}
            \label{fig:mtjeConfMatrixMinAcc}
        \end{subfigure}

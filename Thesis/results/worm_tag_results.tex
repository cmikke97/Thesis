...
\newcommand{\wormTagRocAloha}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/worm_tag_roc_aloha.png}
        \vspace*{-1cm}
...
\newcommand{\wormTagRocJointEmbedding}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/worm_tag_roc_jointEmbedding.png}
        \vspace*{-1cm}
...
\newcommand{\wormTagRocProposedMethod}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/worm_tag_roc_proposedModel.png}
        \vspace*{-1cm}

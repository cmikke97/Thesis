...
\newcommand{\allMeanRocAloha}{
    \begin{figure}[H]
        ...
        \vspace*{-0.2cm}
        \caption[Tags prediction task ALOHA mean ROC curve]{Mean ROC curve and AUC-ROC statistics of the \textBF{ALOHA} model for the prediction of all tags/labels. The line represents the \textit{mean} TPR at a given FPR. Statistics were computed over \textBF{3} training runs, each with random parameter initialization.}
...
\newcommand{\allMeanRocJointEmbedding}{
    \begin{figure}[H]
        ...
        \vspace*{-0.2cm}
        \caption[Tags prediction task Joint Embedding mean ROC curve]{Mean ROC curve and AUC-ROC statistics of the \textBF{Joint Embedding} model for the prediction of all tags/labels. The line represents the \textit{mean} TPR at a given FPR. Statistics were computed over \textBF{3} training runs, each with random parameter initialization.}
...
\newcommand{\allMeanRocMtje}{
    \begin{figure}[H]
        ...
        \vspace*{-0.2cm}
        \caption[Tags prediction task MTJE Model mean ROC curve]{Mean ROC curve and AUC-ROC statistics of the \textBF{MTJE} model for the prediction of all tags/labels. The line represents the \textit{mean} TPR at a given FPR. Statistics were computed over \textBF{3} training runs, each with random parameter initialization.}

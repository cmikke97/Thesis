...
\newcommand{\spywareTagRocAloha}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/spyware_tag_roc_aloha.png}
        \vspace*{-1cm}
...
\newcommand{\spywareTagRocJointEmbedding}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/spyware_tag_roc_jointEmbedding.png}
        \vspace*{-1cm}
...
\newcommand{\spywareTagRocProposedMethod}{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./results/spyware_tag_roc_proposedModel.png}
        \vspace*{-1cm}

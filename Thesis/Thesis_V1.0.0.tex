...
The trends of the classification statistics resulted from the evaluation were then computed and plotted along with the confusion matrix corresponding to the value of '\textit{k}' which produced the best accuracy.

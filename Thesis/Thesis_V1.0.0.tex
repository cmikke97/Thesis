...
\begin{table}[H]
	\caption{AUC-ROC (Area Under Curve) of the different models for the Malware Label prediction task. Best results are shown in \textbf{bold}.}
	\centering
...
\begin{center}
	\begin{longtable}[c]{|p{3,2cm}||p{1,8cm} p{1,8cm} p{1,8cm} p{1,8cm} p{1,8cm}|}
		...
		\multicolumn{6}{|c|}{Malware Label \textbf{TPR}} \\
		\hline
		...
		\hline
		\multicolumn{6}{|c|}{Malware Label \textbf{Accuracy}} \\
		\hline
		...
		\hline
		\multicolumn{6}{|c|}{Malware Label \textbf{Recall}} \\
		\hline
		ALOHA & 0.478$\pm$0.000 & 0.746$\pm$0.000 & 0.885$\pm$0.000 & 0.955$\pm$0.000 & \textBF{0.987$\pm$0.000} \\
		Joint Embedding & - & - & - & - & - \\
		Proposed Model & \textBF{0.524$\pm$0.000} & \textBF{0.752$\pm$0.000} & \textBF{0.889$\pm$0.000} & \textBF{0.956$\pm$0.000} & \textBF{0.987$\pm$0.000} \\
		\hline
		\multicolumn{6}{|c|}{Malware Label \textbf{Precision}} \\
		\hline
		...
		\hline
		\multicolumn{6}{|c|}{Malware Label \textbf{F1 Score}} \\
		\hline

...
However, \textit{metamorphic} malware, in order to efficiently evolve its code it needs to be able to recognise, parse and mutate its own body during propagation. This is far from being easy. Moreover, creating a true \textit{metamorphic} malware without arbitrarly increasing its code size is also challenging \cite{NamanyaTWM}.

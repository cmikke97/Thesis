...
\begin{itemize}
	...
	\item \textbf{\textit{COVID-19 related attacks}} (2020) - In 2020, as the COVID-19 pandemic rocked the global landscape, affecting nearly every person and every industry in the world - hackers took notice. Many cybercriminals took advantage of the people's fear of the novel coronavirus to peddle COVID-19 related phishing scams. From spoofing the World Heath Organization to offering fake remote jobs, hackers used fake communications to deploy malware and hijack sensitive personal data to use for identity theft and other purposes.\\

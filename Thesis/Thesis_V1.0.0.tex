...
\begin{itemize}
	...
	Key logging have also legitimate uses, in fact it is often used by law enforcement, parents, and jealous or suspicious spouses. The most common use, however, is in the workplace, where your employer is monitoring your use of the computer.
	...
	\begin{itemize}
		\item User-level/application level rootkits
		\item Kernel-level rootkits
		\item Hardware rootkits
		\item Bootkit rootkits
		\item Virtualization rootkits
	\end{itemize}
...
\subsubsection{Real-world examples}
	\begin{itemize}
		...
		\item \textit{\textbf{Bots/Botnet} example}: one of the biggest (and worse) botnets in existence is called \textbf{\textit{Mirai}}. This massive botnet of compromised IoT devices - infected with the Mirai malware - is responsible for some of the biggest DDoS attacks in recent years. Mirai botnet was most famously known for taking down huge numbers of websites in 2016.

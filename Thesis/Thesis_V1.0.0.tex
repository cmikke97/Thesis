...
In order to understand why that is and how it could be possible to improve the classifier performance it seems appropriate to carry out a more in-depth study on the different malware families under analysis.
...
Furthermore, this also makes it difficult to assess which proposed \textbf{Family Classifier} misclassifications are actual errors and why the model made those decision - which is already extremely difficult to understand when working with Neural Networks.

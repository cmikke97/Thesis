...
\begin{figure}[h!]
	...
	\caption[AV Atlas Total Malware and PUA Amount Report]{AV Atlas Total Malware and PUA Amount Report}
	\label{fig:avAtlasReport}
\end{figure}

In the following decades malware has evolved both regarding its complexity and malware sample numbers. In particular, in 2019 and 2020 (and until mid 2021 - that is until the time of writing) the number of generated malware blew to the point that currently, according to AV Atlas, approximately 5.1 new Microsoft Windows malware samples are generated per second, $\sim18,500$ per hour \cite{AvAtlas}. Moreover, nowadays malware use obfuscation and other sophisticated techniques, such as Polymorphism and Metamorphism, to evolve their structure thus evading detection.

...
\begin{figure}[h!]
	...
	\caption[\textbf{MTJE} Model architecture]{\textbf{MTJE} Model architecture}
...
\begin{itemize}
	...
	\item On the other hand, a higher-quality (and possibly larger) dataset of PE malicious files with the corresponding family label with respect to the current Fresh Dataset could improve the performance of the \textbf{Family Classifier} and \textbf{Contrastive Model} implementations.

...
\subsection{Comments}
\color{Red}
These results are not directly comparable to the one obtained when evaluating the \textbf{Proposed Model} on the family prediction and ranking tasks since those were obtained using a different procedure.

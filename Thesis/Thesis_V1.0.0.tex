...
\section{Results}
\subsection{Malware label results}
\begin{table}[H]
	\centering
	\begin{tabular}{|p{3cm}||p{1,4cm}|p{1,4cm}|p{1,4cm}|p{1,4cm}|p{1,4cm}|p{1,4cm}|}
		\hline
		\multicolumn{7}{|c|}{Malware label (at FPR $=1\%$)} \\
		\hline
		Model & TPR & Accuracy & Precision & Recall & F1 score & AUC \\
		\hline
		ALOHA & \textbf{0,955483} & \textbf{0,976642} & \textbf{0,983697} & \textbf{0,955483} & \textbf{0,969385} & \textbf{0,994223} \\
		Joint Embedding & - & - & - & - & - & - \\
		\hline
	\end{tabular}
\end{table}
...
\subsection{Mean per-sample scores}
\begin{table}[H]
	\centering

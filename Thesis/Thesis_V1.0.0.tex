...
More specifically, in algorithm \ref{alg:Alt3FastDataLoaderInit} ..
...
\begin{algorithm}
	\caption{Alt3 FastTensorDataLoader class, Iter}\label{Alt3FastDataLoaderIter}
	\begin{algorithmic}[1]
		\algrestore{bkbreak}
		\Function{Iter}{\textit{self}}
		\If{\textit{self.shuffle} $=$ \textit{true}}
...
\begin{algorithm}
	\caption{Alt3 FastTensorDataLoader class, Next}\label{Alt3FastDataLoaderNext}
	\begin{algorithmic}[1]
		\algrestore{bkbreak}
			\Function{Next}{\textit{self}}
				\If{\textit{self.num\_workers} $= 1$}

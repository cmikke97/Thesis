...
\begin{algorithm}[h!]
	\caption{MTJE Model Net class, Init}\label{alg:mtjeModelNetInit}
	\begin{algorithmic}[1]
		\Class{Net}
			\Function{Init}{\textit{self}, \textit{use\_malware}, \textit{use\_counts}, \textit{use\_tags}, \textit{n\_tags}, \textit{feature\_dimension}, \textit{embedding\_dimension}, \textit{max\_embedding\_norm}, \textit{layer\_sizes}, \textit{dropout\_p}, \textit{activation\_function}, \textit{normalization\_function}}	
			\State
...
\begin{algorithm}[h!]
	\caption{MTJE Model Net class, Forward (with \textit{Dot Product})}\label{alg:mtjeModelNetForwardDotProduct}
	\begin{algorithmic}[1]
		\algrestore{bkbreak}
		\Function{Forward}{\textit{self}, \textit{data}}
		\State \textit{rv} $\gets$ \{\}
...
\begin{algorithm}[h!]
	\caption{MTJE Model Net class, Forward (with \textit{Cosine similarity})}\label{alg:mtjeModelNetForwardCosine}
	\begin{algorithmic}[1]
		\algrestore{bkbreak}
		\Function{Forward}{\textit{self}, \textit{data}}
		\State ...
...
\begin{algorithm}[h!]
	\caption{MTJE Model Net class, Forward (with \textit{Inverted Pairwise Euclidean Distance})}\label{alg:mtjeModelNetForwardPairwiseDistance}
	\begin{algorithmic}[1]
		\algrestore{bkbreak}
		\Function{Forward}{\textit{self}, \textit{data}}
		\State ...
...
\begin{algorithm}[h!]
	\caption{MTJE Model Net class, Compute Loss}\label{alg:mtjeModelNetComputeLoss}
	\begin{algorithmic}[1]
		\algrestore{bkbreak}
		\Function{ComputeLoss}{\textit{predictions}, \textit{labels}, \textit{loss\_wts}}
		\If{\textit{loss\_wts} \textbf{is} None}
...
\begin{algorithm}[h!]
	\caption{Contrastive Learning Model Net class, Init}\label{alg:contrastiveLearningModelNetInit}
	\begin{algorithmic}[1]
		\Class{Net}

...
\begin{algorithm}[h]
	\caption{Joint Embedding Net class, Forward}\label{alg:jointEmbeddingNetForward}
	\begin{algorithmic}[1]
		\algrestore{bkbreak}
		\Function{Forward}{\textit{self}, \textit{data}}
		\State \textit{rv} $\gets$ \{\}
...
\begin{algorithm}[h]
	...
	\begin{algorithmic}[1]
		...
		\State \hskip7.5em \textit{labels}['tags'],
		\State \hskip7.5em reduction='none').\textbf{sum}(dim=1).\textbf{mean}(dim=0)
		\State

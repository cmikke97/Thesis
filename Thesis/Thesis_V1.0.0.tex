...
The confusion matrixes corresponding to the different \textbf{Family Classifiers}, shown by figures \ref{fig:FamilyClassifierJointEmbeddingConfusionMatrix}, \ref{fig:FamilyClassifierProposedModelConfusionMatrix} and \ref{fig:FamilyClassifierOnlyConfusionMatrix}, reflect these results.

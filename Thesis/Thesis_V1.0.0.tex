...
Therefore the loss to minimize during training, given a triplet $(a, p, n)$ and a distance function $d(a, b)$ between two data points $a$ and $b$ (which was set to be the \textit{Euclidean Norm}), is:
\begin{equation}

...
In this project the \textit{Triplet loss} was used in order to learn good embeddings for the input PE files such that, in the embedding space, PE files from the same family should be close together and form well separated clusters.

The goal of the \textit{Triplet loss} is to make sure that:
\begin{itemize}
	\item Two examples with the same label have their embeddings close together in the embedding space

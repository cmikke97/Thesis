...
\section{Total Computation Time}
\begin{table}[H]
	\centering
	\begin{tabular}{|P{4,5cm}||P{2,6cm} P{2,6cm} P{2,6cm}|}
		...
		\hline
		Complete Workflow & 3h 24m 35s & 1 & 10h 19m 9s \\
		\hline
	\end{tabular}
	\caption[Computation Time Per Experiment]{Computation Time Required to complete one experiment.}

...
\begin{algorithm}[h!]
	\caption{Alt1 GetBatchh function}\label{alg:Alt1GetBatch}
	\begin{algorithmic}[1]
...
The \textit{\textbf{evaluate\_fresh}} function provides, together with the \textbf{MRR} and \textbf{MAP} scores, the complete rankings for the $q$ query samples in a single \textit{json} file. Moreover, for convenience, 4 particular rankings are also saved as \textit{csv} files. These 4 rankings are those that produced:
\begin{itemize}

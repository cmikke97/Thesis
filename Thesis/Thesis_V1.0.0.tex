...
It is interesting to notice how samples belonging to the \textbf{\textit{Trickbot}} family, which are frequently loaded on infected hosts by \textbf{\textit{Heodo}}, get often mistaken by the proposed \textbf{Family Classifier} for samples belonging to the \textbf{\textit{Heodo}} family.
